...
export default function (osi4iotState) {
	...
	const mosquittoGoAuthConf = [
		...
		"auth_opt_http_host iot-fibre4yards.com\n",
		"auth_opt_http_port 3200\n",
		"auth_opt_http_getuser_uri /admin_api/auth/mosquitto_user\n",
		"auth_opt_http_aclcheck_uri /admin_api/auth/mosquitto_aclcheck\n",
