...
func initialModelCreatePlatform() Model {
	...
	model := Model{
		Questions: []Question{
			...
			{
				Key:           "IOT_DATA_SVC_RESOURCES",
				QuestionType:  "list",
				Prompt:        "Select IoT data services resources",
				Answer:        data.Data.PlatformInfo.IotDataSvcResources,
				DefaultAnswer: "",
				ErrorMessage:  "",
				Choices:       []string{"0.25CPU-500Mb", "0.5CPU-1000Mb", "1CPU-2000Mb", "2CPU-4000Mb", "4CPU-8000Mb"},
				ChoiceFocus: utils.GiveChoiceFocus(data.Data.PlatformInfo.IotDataSvcResources,
					[]string{"0.25CPU-500Mb", "0.5CPU-1000Mb", "1CPU-2000Mb", "2CPU-4000Mb", "4CPU-8000Mb"}, 0),
				Rules:     []string{"required"},
				ActionKey: "",
				Margin:    0,
			},
			{
				...
				QuestionType:  "list",
				Prompt:        "Select admin data storage services resources",
