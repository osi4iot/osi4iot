	...
	model := Model{
		Questions: []Question{
			...
			},
			{
				...
				QuestionType:  "generic",
				Prompt:        "LLM provider URL",
				Answer:        data.Data.PlatformInfo.LlmProviderUrl,
				DefaultAnswer: "https://openrouter.ai/api/v1",
				ErrorMessage:  "",
				Choices:       []string{},
				ChoiceFocus:   0,
				Rules:         []string{"required", "url"},
			...
			},
			{
				...
				QuestionType:  "password",
				Prompt:        "LLM provider API key",
				Answer:        data.Data.PlatformInfo.LlmProviderApiKey,
				DefaultAnswer: "",
				ErrorMessage:  "",
				Choices:       []string{},
				ChoiceFocus:   0,
			...
			},
			{
				...
				DefaultAnswer: "",
				ErrorMessage:  "",
				Choices:       []string{"No service","0.25CPU-500Mb", "0.5CPU-1000Mb", "1CPU-2000Mb", "2CPU-4000Mb"},
				ChoiceFocus: utils.GiveChoiceFocus(data.Data.PlatformInfo.PipelinesSvcResources,
					[]string{"No service","0.25CPU-500Mb", "0.5CPU-1000Mb", "1CPU-2000Mb", "2CPU-4000Mb"}, 0),
				Rules:     []string{"required"},
				ActionKey: "",
				Margin:    0,
			},
