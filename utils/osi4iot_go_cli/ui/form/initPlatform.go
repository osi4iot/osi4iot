	...
	model := Model{
		Questions: []Question{
			...
			},
			{
				...
				Choices:       []string{},
				ChoiceFocus:   0,
				Rules:         []string{"required", "int", "maxlen:15"},
				ActionKey:     "",
				Margin:        0,
			},
			{
				...
				Choices:       []string{},
				ChoiceFocus:   0,
				Rules:         []string{"required", "url", "maxlen:60"},
				ActionKey:     "",
				Margin:        0,
			},
			{
			...
			{
				Key:           "USE_PATRONI_TOOL",
				QuestionType:  "list",
				Prompt:        "Use Patroni for high-availability databases?",
				Answer:        utils.BoolValueToStr(data.Data.PlatformInfo.UsePatroniTool),
				DefaultAnswer: "no",
				Choices:       []string{"yes", "no"},
				ChoiceFocus:   utils.GiveChoiceFocus(utils.BoolValueToStr(data.Data.PlatformInfo.UsePatroniTool), []string{"yes", "no"}, 1),
				Rules:         []string{"required", "string"},
				ActionKey:     "usePatroniToolQuestions",
				Margin:        0,
			},
			{
