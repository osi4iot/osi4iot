...
func initialModelCreatePlatform() Model {
	...
	model := Model{
		Questions: []Question{
			...
			{
				Key:           "NUMBER_OF_NATS_NODES",
				QuestionType:  "list",
				Prompt:        "Number of swarm nodes dedicated to NATS messaging service",
				Answer:        utils.IntValueToStr(data.Data.PlatformInfo.NumOfNatsNodes),
				DefaultAnswer: "1",
				ErrorMessage:  "",
			...
			{
				Key:           "DEFAULT_NUMBER_OF_NATS_REPLICAS",
				QuestionType:  "list",
				Prompt:        "Number of nats servers",
				Answer:        utils.IntValueToStr(data.Data.PlatformInfo.DefaultNumOfNatsReplicas),
				DefaultAnswer: "1",
				ErrorMessage:  "",
				Choices:       []string{"1", "3", "5"},
				ChoiceFocus:   0,
			...
			{
				Key:           "USE_CUSTOM_NATS_CA_CERT",
				QuestionType:  "list",
				Prompt:        "Use custom CA cert for NATS TLS connections",
				Answer:        data.Data.PlatformInfo.UseCustomNatsCACert,
				DefaultAnswer: "No",
				ErrorMessage:  "",
			...
			{
				Key:           "DEFAULT_NUMBER_OF_PIPELINES_INSTANCES",
				QuestionType:  "list",
				Prompt:        "Default number of pipelines instances",
				Answer:        utils.IntValueToStr(data.Data.PlatformInfo.DefaultNumPipelinesInstances),
				DefaultAnswer: "1",
				ErrorMessage:  "",
				Choices:       []string{"1", "3", "5"},
				ChoiceFocus: utils.GiveChoiceFocus(strconv.Itoa(data.Data.PlatformInfo.DefaultNumPipelinesInstances),
					[]string{"1", "3", "5"}, 0),
				Rules:     []string{"required"},
				ActionKey: "",
				Margin:    0,
