...
interface MobileAccelerationFormProps {
...
const MobileAccelerationForm: FC<MobileAccelerationFormProps> = (
    {
        natsClient,
        isNatsConnected,
    ...
    return (
        <>
            <Title>
                Mobile accelerations <ConnectionLed isNatsConnected={isNatsConnected} />
            </Title>
            <FormContainer>
...
export default MobileAccelerationForm;