...
import { setDevicesOptionToShow, useDevicesDispatch, useDevicesOptionToShow, useDevicesPreviousOption } from '../../contexts/devicesOptions';
import CreateDevice from './CreateDevice';
import EditDevice from './EditDevice';
import DeviceLocationContainer from './DeviceLocationContainer';
import { useBuildingsTable, useFloorsTable, useGroupsManagedTable } from '../../contexts/platformAssistantContext';
