...
import { setDeviceCircleColor } from "./DeviceSvgImage";
import { IDevice } from "../TableColumns/devicesColumns";

interface MaterialDeviceSvgImageProps {
    deviceId: number,
...
export const MaterialDeviceSvgImage: FC<MaterialDeviceSvgImageProps> = ({
    deviceId,
    deviceSelected,
    fillColor,
    bounds,
