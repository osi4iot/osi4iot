...
export const setDeviceCircleColor = (deviceId: number, deviceSelected: IDevice | null): string => {
...
export const DeviceSvgImage: FC<DeviceSvgImageProps> = ({
    deviceId,
    deviceSelected,
    fillColor,
    bounds,
    ...
    return (
        <>
            <SVGOverlay attributes={{ viewBox: "0 0 600 600", fill: fillColor }} bounds={outerBounds as LatLngTuple[]}>
                <circle
                    fill="#555555"
                    stroke={setDeviceCircleColor(deviceId, deviceSelected)}
                    stroke-width="5"
                    cx="300"
                    cy="300"
                    r="290"
