...
const DigitanTwinSvgImage: FC<DigitanTwinSvgImageProps> = ({
    ...
    return (
        <>
            <SVGOverlay attributes={{ viewBox: "0 0 512 512", fill: fillColor }} bounds={bounds as LatLngTuple[]}>
                <path
                    d="M258.7,113.7c0.5,7.9-4.5,11.7-8.4,15.9c-3.3,3.5-4.7,6.7-4.1,11.8c0.9,7.7,1.1,15.7,0.1,23.4c-0.8,6.3,1.2,10.4,5.2,14.7
	...
	C258.7,111.3,258.6,113.2,258.7,113.7z"
                />
                <path
                    d="M375.6,160c0-24.9-0.2-49.8,0.1-74.7c0.1-5.4-1.6-6.3-6.6-6.3c-25.9,0.2-51.9,0.1-77.8,0.1c-10.3,0-16.3-4.7-16.2-12.7
	...
	C374.3,161,374.9,160.5,375.6,160z"
                />
                <path
                    d="M107.7,334.1c0,25.4,0.2,50.8-0.1,76.2c-0.1,5.4,2.9,4.8,6.3,4.8c26.8,0,53.6-0.1,80.3,0c8.4,0,13.9,5.1,14,12.4
	...
	c-3.7-3.4-6.8-7.3-10.2-10.9C108.9,333.4,108.3,333.8,107.7,334.1z"
                />
                <path
                    d="M207.3,207.1c-4.3,0.2-7.6,2.1-10.5,4.9c-7.8,7.3-16.7,13.3-27,16.3c-8.5,2.4-13.8,7-15.2,15.6c-1,6.2-4.6,7.2-10,6.7
	...
	C212.2,207.6,209.5,207.6,207.3,207.1z"
                ...
                <path
                    fill="#555555"
                    d="M97.3,154.1c-0.1-25.8,20.5-46.5,46.1-46.4c25.1,0.1,45.8,20.8,45.9,46c0.2,25.4-20.9,46.5-46.3,46.4
	C117.8,200,97.4,179.5,97.3,154.1z"
                />
                <path
                    fill="#555555"
                    d="M143.2,174.9c-11.4,0-20.6-9.1-20.7-20.6c-0.2-11.9,9.1-21.4,20.8-21.4c11.3,0,20.7,9.3,21,20.6
	C164.5,165,154.7,174.9,143.2,174.9z"
                />
                <path
                    d="M465.7,324.4c0.5,7.9-4.5,11.7-8.4,15.9c-3.3,3.5-4.7,6.7-4.1,11.8c0.9,7.7,1.1,15.7,0.1,23.4c-0.8,6.3,1.2,10.4,5.2,14.7
	c9.5,10.3,9.6,13,2.7,25c-4.6,8-9.3,15.9-13.8,23.9c-3.9,7.1-9.4,10.1-17.3,7.4c-8.2-2.8-15.6-2.3-22,4.5c-1.5,1.6-3.6,2.7-5.6,3.6
	c-11.2,4.7-21,10.4-23,24.3c-0.7,4.8-5.8,7.4-11,7.4c-12,0.1-24,0.1-36,0c-6.7,0-11.4-3.6-12.7-10c-1.9-10.1-7.4-16.2-17.1-18.9
	...
	C465.7,322,465.6,323.9,465.7,324.4z"
                />
                <path
                    d="M414.3,417.8c-4.3,0.2-7.6,2.1-10.5,4.9c-7.8,7.3-16.7,13.3-27,16.3c-8.5,2.4-13.8,7-15.2,15.6c-1,6.2-4.6,7.2-10,6.7
	...
	C419.2,418.3,416.5,418.3,414.3,417.8z"
                ...
                <path
                    fill="#555555"
                    d="M304.3,364.8c-0.1-25.8,20.5-46.5,46.1-46.4c25.1,0.1,45.8,20.8,45.9,46c0.2,25.4-20.9,46.5-46.3,46.4
	C324.8,410.7,304.4,390.2,304.3,364.8z"
                />
                <path
                    fill="#555555"
                    d="M350.2,385.6c-11.4,0-20.6-9.1-20.7-20.6c-0.2-11.9,9.1-21.4,20.8-21.4c11.3,0,20.7,9.3,21,20.6
...
const GeoDigitalTwin: FC<GeoDigitalTwinProps> = ({
    ...
    const bounds = useMemo(
        () => calcGeoBounds(centerLongitude, centerLatitude, digitalTwinRadio),
        [centerLongitude, centerLatitude, digitalTwinRadio],
    );

    const digitalTwinOuterRadio = 0.0002 * assetData.iconRadio;
    const outerBounds = useMemo(
        () => calcGeoBounds(centerLongitude, centerLatitude, digitalTwinOuterRadio),
        ...
        <>
            {status !== "unknown" && fillColor !== "unknown" && (
                ...
                >
                    ...
                    />
                    <Tooltip sticky>
                        <span style={{ fontWeight: "bold" }}>Digital twin</span>
                        <br />
                        Name: {digitalTwinData.digitalTwinRef}
                        <br />
                        Description: {digitalTwinData.description}
                        <br />
                        Status:{" "}
                        <span style={{ fontWeight: "bold" }}>{status.charAt(0).toUpperCase() + status.slice(1)}</span>
                    </Tooltip>
                </Circle>
            )}
        </>
