...
interface NodeRedInstanceSvgImageProps {
    bounds: LatLngTuple[];
    clickNodeRedInstanceHandler: () => void;
}

export const NodeRedInstanceSvgImage: FC<NodeRedInstanceSvgImageProps> = ({
    bounds,
    clickNodeRedInstanceHandler
}) => {

    return (
        <>
                <SVGOverlay
                    attributes={{ viewBox: "0 0 560.00001 647.00001", fill: "#ffffff" }}
                ...
                >
                    <g transform="translate(0 -405.36)">
                        <g transform="translate(.000014172 .000022107)">
                            <path opacity="0.98" colorRendering="auto" color="#000000" mix-blend-mode="normal" shapeRendering="auto" solid-color="#000000" imageRendering="auto" d="m280 405.36 280 162.03v323.32l-280 161.69-280-161.7-0.0000055092-323.41z" fill="#8f0000" />
