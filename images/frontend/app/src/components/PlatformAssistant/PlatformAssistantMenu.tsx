...
import { PLATFORM_ASSISTANT_OPTION, PLATFORM_ASSISTANT_ROUTES } from "./platformAssistantOptions";
...
const PlatformLogoContainer = styled.div<PlatformLogoContainerProps>`
	background-color: #141619;
	width: 50px;
    height: 50px;
    padding-top: 3px;
