...
export const createHandlers = (
    ...
    //                                 pipelineData.nodes[inode].settings = JSON.stringify(
    //                                     pipelineData.nodes[inode].settings
    //                                 );
    //                             }
    //                         }
    ...
    //                                     setters.setPipelineLogsOpen(true);
    //                                     setters.setIsPipelineChanged(false);
    //                                     toast.success(response.data.message);
    //                                 })
    //                                 .catch((error: AxiosError) => {
    //                                     axiosErrorHandler(error, authDispatch);
    ...
    // const handleChangePipeline = (isChanged: boolean) => {
    //     setters.setIsPipelineChanged(isChanged);
    // };
