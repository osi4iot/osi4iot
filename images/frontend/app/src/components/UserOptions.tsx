    ...
    return (
        <>
            <UserOptionsContainer>
                <OptionContainer isOptionActive={optionToShow === "User profile"} onClick={() => clickHandler("User profile")}>
                    User profile
                </OptionContainer>
                <OptionContainer isOptionActive={optionToShow === "Membership in orgs"} onClick={() => clickHandler("Membership in orgs")}>
                    Membership in orgs
                </OptionContainer>
                <OptionContainer isOptionActive={optionToShow === "Membership in groups"} onClick={() => clickHandler("Membership in groups")}>
            ...
            <ContentContainer >
                {(userProfileLoding || loadingOrgsMembership || loadingGroupsMembership) ?
                    ...
                    :
                    <>
                        {optionToShow === "User profile" && <UserProfile userProfile={userProfile} />}
                        {optionToShow === "Membership in orgs" && <TableWithPagination dataTable={orgsMembership} columnsTable={MEMBERSHIP_IN_ORGS} componentName="" />}
                        {optionToShow === "Membership in groups" && <TableWithPagination dataTable={groupsMembership} columnsTable={MEMBERSHIP_IN_GROUPS} componentName="" />}
                    </>
                }
            </ContentContainer>
        </>
