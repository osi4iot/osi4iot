...
import { getDigitalTwinByProp } from "../../digitalTwin/digitalTwinDAL";
...
class WireController implements IController {
	...
	private initializeRoutes(): void {
		this.router
			...
			.get(
				`${this.path}s_for_node_ini/:groupId/:digitalTwinId/:nodeIniId`,
				groupExists,
				groupAdminAuth,
				this.getWiresForNodeIni
			)
			.get(
				`${this.path}s_for_node_end/:groupId/:digitalTwinId/:nodeEndId`,
				groupExists,
				groupAdminAuth,
	...
	private getWiresInDigitalTwin = async (
		req: IRequestWithGroup,
		res: Response,
		next: NextFunction
	): Promise<void> => {
